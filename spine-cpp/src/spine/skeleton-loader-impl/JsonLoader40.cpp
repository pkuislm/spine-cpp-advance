...
SkeletonData *JsonLoader40::readSkeleton(Json *root, SkeletonData *skeletonData) {
    int i, ii;
    ...
    for (boneMap = bones->_child, i = 0; boneMap; boneMap = boneMap->_next, ++i) {
        ...
        inherit = Json::getString(boneMap, "transform", "normal");
...
void JsonLoader40::setBezier(CurveTimeline *timeline, int frame, int value, int bezier, float time1, float value1, float cx1,
                             float cy1,
                             float cx2, float cy2, float time2, float value2) {
    timeline->setBezier(bezier, frame, value, time1, value1, cx1, cy1, cx2, cy2, time2, value2);
}

int JsonLoader40::readCurve(Json *curve, CurveTimeline *timeline, int bezier, int frame, int value, float time1,
                            float time2,
...
Timeline *JsonLoader40::readTimeline(Json *keyMap, CurveTimeline1 *timeline, float defaultValue, float scale) {
...
Timeline *JsonLoader40::readTimeline(Json *keyMap, CurveTimeline2 *timeline, const char *name1, const char *name2,
...
int JsonLoader40::findSlotIndex(SkeletonData *skeletonData, const String &slotName, Vector<Timeline *> timelines) {
...
Animation *JsonLoader40::readAnimation(Json *root, SkeletonData *skeletonData) {
...
void JsonLoader40::readVertices(Json *attachmentMap, VertexAttachment *attachment, size_t verticesLength) {
    Json *entry;
