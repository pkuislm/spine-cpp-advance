...
SkeletonData *JsonLoader42::readSkeleton(Json *root, SkeletonData *skeletonData) {
    int i, ii;
    Json *bones, *boneMap, *ik, *transform, *path, *physics, *slots, *skins, *animations, *events;
...
Sequence *JsonLoader42::readSequence(Json *item) {
...
void JsonLoader42::setBezier(CurveTimeline *timeline, int frame, int value, int bezier, float time1, float value1, float cx1,
                             float cy1,
                             float cx2, float cy2, float time2, float value2) {
    timeline->setBezier(bezier, frame, value, time1, value1, cx1, cy1, cx2, cy2, time2, value2);
}

int JsonLoader42::readCurve(Json *curve, CurveTimeline *timeline, int bezier, int frame, int value, float time1,
                            float time2,
...
Timeline *JsonLoader42::readTimeline(Json *keyMap, CurveTimeline1 *timeline, float defaultValue, float scale) {
...
Timeline *JsonLoader42::readTimeline(Json *keyMap, CurveTimeline2 *timeline, const char *name1, const char *name2,
...
int JsonLoader42::findSlotIndex(SkeletonData *skeletonData, const String &slotName, Vector<Timeline *> timelines) {
...
Animation *JsonLoader42::readAnimation(Json *root, SkeletonData *skeletonData) {
...
void JsonLoader42::readVertices(Json *attachmentMap, VertexAttachment *attachment, size_t verticesLength) {
    Json *entry;
