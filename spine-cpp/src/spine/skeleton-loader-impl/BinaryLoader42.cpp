...
SkeletonData *BinaryLoader42::readSkeleton(DataInput *input, SkeletonData *skeletonData) {
    bool nonessential;
...
Skin *BinaryLoader42::readSkin(DataInput *input, bool defaultSkin, SkeletonData *skeletonData, bool nonessential) {
    Skin *skin;
    int slotCount = 0;
    if (defaultSkin) {
...
Sequence *BinaryLoader42::readSequence(DataInput *input) {
...
Attachment *BinaryLoader42::readAttachment(DataInput *input, Skin *skin, int slotIndex, const String &attachmentName,
...
int BinaryLoader42::readVertices(DataInput *input, Vector<float> &vertices, Vector<int> &bones, bool weighted) {
    float scale = _scale;
...
void BinaryLoader42::readShortArray(DataInput *input, Vector<unsigned short> &array, int n) {
    array.setSize(n, 0);
    for (int i = 0; i < n; ++i) {
...
void BinaryLoader42::setBezier(DataInput *input, CurveTimeline *timeline, int bezier, int frame, int value, float time1,
                               float time2,
...
void BinaryLoader42::readTimeline(DataInput *input, Vector<Timeline *> &timelines, CurveTimeline1 *timeline, float scale) {
...
void BinaryLoader42::readTimeline2(DataInput *input, Vector<Timeline *> &timelines, CurveTimeline2 *timeline, float scale) {
    float time = readFloat(input);
...
Animation *BinaryLoader42::readAnimation(const String &name, DataInput *input, SkeletonData *skeletonData) {
